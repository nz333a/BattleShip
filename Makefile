#############################################################################
# Makefile for building: BattleShip.app/Contents/MacOS/BattleShip
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Mar 12 03:28:01 2015
# Project:  BattleShip.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile BattleShip.pro
#############################################################################
...
DESTDIR       = 
TARGET        = BattleShip.app/Contents/MacOS/BattleShip
...
all: Makefile BattleShip.app/Contents/PkgInfo BattleShip.app/Contents/Resources/empty.lproj BattleShip.app/Contents/Info.plist $(TARGET)

$(TARGET):  $(OBJECTS)  
	@$(CHK_DIR_EXISTS) BattleShip.app/Contents/MacOS/ || $(MKDIR) BattleShip.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: BattleShip.pro  /usr/local/Cellar/qt/4.8.6/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.6/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/clang.conf \
...
BattleShip.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) BattleShip.app/Contents || $(MKDIR) BattleShip.app/Contents 
	@$(DEL_FILE) BattleShip.app/Contents/PkgInfo
	@echo "APPL????" >BattleShip.app/Contents/PkgInfo
BattleShip.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) BattleShip.app/Contents/Resources || $(MKDIR) BattleShip.app/Contents/Resources 
	@touch BattleShip.app/Contents/Resources/empty.lproj
	
BattleShip.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) BattleShip.app/Contents || $(MKDIR) BattleShip.app/Contents 
	@$(DEL_FILE) BattleShip.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,BattleShip,g" -e "s,@TYPEINFO@,????,g" /usr/local/Cellar/qt/4.8.6/mkspecs/unsupported/macx-clang-libc++/Info.plist.app >BattleShip.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) .tmp/BattleShip1.0.0 || $(MKDIR) .tmp/BattleShip1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/BattleShip1.0.0/ && $(COPY_FILE) --parents dialog.h .tmp/BattleShip1.0.0/ && $(COPY_FILE) --parents dialog.cc main.cc .tmp/BattleShip1.0.0/ && (cd `dirname .tmp/BattleShip1.0.0` && $(TAR) BattleShip1.0.0.tar BattleShip1.0.0 && $(COMPRESS) BattleShip1.0.0.tar) && $(MOVE) `dirname .tmp/BattleShip1.0.0`/BattleShip1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/BattleShip1.0.0
...
moc_dialog.cpp: dialog.h
	/usr/local/Cellar/qt/4.8.6/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ dialog.h -o moc_dialog.cpp
