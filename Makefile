...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Mar 11 00:50:39 2015
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/BattleShip1.0.0/ && $(COPY_FILE) --parents main.cc .tmp/BattleShip1.0.0/ && (cd `dirname .tmp/BattleShip1.0.0` && $(TAR) BattleShip1.0.0.tar BattleShip1.0.0 && $(COMPRESS) BattleShip1.0.0.tar) && $(MOVE) `dirname .tmp/BattleShip1.0.0`/BattleShip1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/BattleShip1.0.0
